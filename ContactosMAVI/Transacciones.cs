...
namespace ContactosMAVI
{
     class Transacciones
    {
        ...
        //Enumerables para los datos

        public Dictionary<char, string> tipoContacto = new Dictionary<char, string>
        {
            { 'A', "Amistad" },
            { 'F', "Familiar" },
            { 'T', "Trabajo" }
        ...
        public Dictionary<char, string> sexo = new Dictionary<char, string>
        {
            {'F', "Femenino" },
            {'M', "Masculino" }
        };

        public Dictionary<char, string> estadoCivil = new Dictionary<char, string> {
            { 'S', "Soltero"},
            { 'C', "Casado"},
            { 'D', "Divorciado"},
            { 'V', "Viudo"},
